...
knitr::kable(round(codes_tbl,digits = 3), format = "latex", caption = "\\label{tab:tab_som} Importance of each variable for each cell with the self-organizing map of the student activities across the three courses (year 2020-2021).") %>.%
