...
The plots in gray scale show how metrics distribute in the nine cells, from lowest value in white to highest value in black.

```{r}
codessom <- sdd_som[["codes"]][[1]]
row.names(codessom) <- paste0("gr", c(7:9, 4:6, 1:3)) 
