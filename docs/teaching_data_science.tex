...
obtained for the projects for courses A and B.}
\end{figure}
...
two weeks of course. b. Contributions by question asked (log scale), as
a proxy measure of the effect of student-teacher interactions on the
progression of data analysis. Light gray background indicates periods
where distance teaching was mandatory due to covid lockdown.}
\end{figure}
