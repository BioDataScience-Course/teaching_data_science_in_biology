...
with these high-level cognitive skills {[}1{]}. Our teaching and
...
benefit of improving student outcomes {[}1{]}. Moreover, it allows
...
pedagogical practices on the outcome of these courses {[}{[}2{]}; second
ref to add{]}. A vast amount of data can be collected on students'
activities, and the analysis of these data allows comparing the impact
...
scale to quantify the perceived workload to complete a task {[}3{]}. The
...
constitutes a Raw Task Load indeX (RTLX) {[}4{]} that we used to
...
knowledge in mathematics and statistics is a hard task {[}5{]}. Our
...
{[}add IDEA : {[}6{]} montre les bon résultats abtenu avec la classe
inversée et les challenge en biologie lors de son cours de 2018.{]}
...
Proactive behaviour and autonomy are required {[}1{]}. They thus have to
...
found with a critical mind {[}7{]}. This task is complex, especially for
...
\leavevmode\hypertarget{ref-Compeau2019}{}%
\CSLLeftMargin{6. }
\CSLRightInline{Compeau P (2019) {Establishing a computational biology
flipped classroom}. \emph{PLoS Computational Biology} 15: 1--8.}
...
\leavevmode\hypertarget{ref-Siemens2013}{}%
\CSLLeftMargin{8. }
\CSLRightInline{Siemens G (2013) {Learning Analytics: The Emergence of a
Discipline}. \emph{American Behavioral Scientist} 57: 1380--1400.}
