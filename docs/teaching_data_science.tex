...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lessons19 }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., }\SpecialCharTok{!}\NormalTok{topic }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"extra\_session"}\NormalTok{, }\StringTok{"debriefing\_S{-}BIOG{-}006"}\NormalTok{, }\StringTok{"debriefing\_S{-}BIOG{-}015"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., icourse }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"S{-}BIOG{-}027"}\NormalTok{, }\StringTok{"S{-}BIOG{-}061"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{group\_by}\NormalTok{(., course, module) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{summarise}\NormalTok{(., }\AttributeTok{start =} \FunctionTok{min}\NormalTok{(start), }\AttributeTok{end =} \FunctionTok{max}\NormalTok{(end)) }\OtherTok{{-}\textgreater{}}\NormalTok{ lessons\_red19}
...
\NormalTok{log19 }\SpecialCharTok{\%\textgreater{}.\%}
  ...
  \FunctionTok{count}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{ungroup}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{mutate}\NormalTok{(., }\AttributeTok{cumul\_commit =} \FunctionTok{cumsum}\NormalTok{(n)) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., date\_round }\SpecialCharTok{\textgreater{}=}\NormalTok{ courses19}\SpecialCharTok{$}\NormalTok{start[courses19}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}027"}\NormalTok{] }\SpecialCharTok{\&}\NormalTok{ date\_round }\SpecialCharTok{\textless{}=}\NormalTok{ courses19}\SpecialCharTok{$}\NormalTok{end[courses19}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}027"}\NormalTok{])}\OtherTok{{-}\textgreater{}}\NormalTok{ log\_temp19}

\NormalTok{support19 }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{mutate}\NormalTok{(., }\AttributeTok{date\_round =}\NormalTok{ lubridate}\SpecialCharTok{::}\FunctionTok{round\_date}\NormalTok{(date, }\StringTok{"day"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{group\_by}\NormalTok{(., date\_round) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{count}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{ungroup}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{mutate}\NormalTok{(., }\AttributeTok{cumul\_message =} \FunctionTok{cumsum}\NormalTok{(n))  }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., date\_round }\SpecialCharTok{\textgreater{}=}\NormalTok{ courses19}\SpecialCharTok{$}\NormalTok{start[courses19}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}027"}\NormalTok{] }\SpecialCharTok{\&}\NormalTok{ date\_round }\SpecialCharTok{\textless{}=}\NormalTok{ courses19}\SpecialCharTok{$}\NormalTok{end[courses19}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}027"}\NormalTok{]) }\OtherTok{{-}\textgreater{}}\NormalTok{ sup\_temp19}

\NormalTok{plog19 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =}\NormalTok{ log\_temp19, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ cumul\_commit, }\AttributeTok{x =}\NormalTok{ date\_round)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Date"}\NormalTok{, }\AttributeTok{y =} \StringTok{"cumulative sum of }\SpecialCharTok{\textbackslash{}n}\StringTok{ commits"}\NormalTok{)}
...
channels, by email and via Discord. However, we observe a clear halt in
the work of the students before the start of the lockdown. After a
period of ten days, students started to work and interact with teachers
again. After the last hours of class, students continued to work and
interact with the teachers.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lessons }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., }\SpecialCharTok{!}\NormalTok{topic }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"extra\_session"}\NormalTok{, }\StringTok{"debriefing\_S{-}BIOG{-}006"}\NormalTok{, }\StringTok{"debriefing\_S{-}BIOG{-}015"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., icourse }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"S{-}BIOG{-}006"}\NormalTok{, }\StringTok{"S{-}BIOG{-}015"}\NormalTok{, }\StringTok{"S{-}BIOG{-}025"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{group\_by}\NormalTok{(., course, module) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{summarise}\NormalTok{(., }\AttributeTok{start =} \FunctionTok{min}\NormalTok{(start), }\AttributeTok{end =} \FunctionTok{max}\NormalTok{(end)) }\OtherTok{{-}\textgreater{}}\NormalTok{ lessons\_red}
...
\NormalTok{log }\SpecialCharTok{\%\textgreater{}.\%}
  ...
  \FunctionTok{ungroup}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{mutate}\NormalTok{(., }\AttributeTok{cumul\_commit =} \FunctionTok{cumsum}\NormalTok{(n))}\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., date\_round }\SpecialCharTok{\textgreater{}=}\NormalTok{ courses}\SpecialCharTok{$}\NormalTok{start[courses}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}006"}\NormalTok{] }\SpecialCharTok{\&}\NormalTok{ date\_round }\SpecialCharTok{\textless{}=}\NormalTok{ courses}\SpecialCharTok{$}\NormalTok{end[courses}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}006"}\NormalTok{])}\OtherTok{{-}\textgreater{}}\NormalTok{ log\_temp}

\NormalTok{support }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{mutate}\NormalTok{(., }\AttributeTok{date\_round =}\NormalTok{ lubridate}\SpecialCharTok{::}\FunctionTok{round\_date}\NormalTok{(date, }\StringTok{"day"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{group\_by}\NormalTok{(., date\_round) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{count}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{ungroup}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{mutate}\NormalTok{(., }\AttributeTok{cumul\_message =} \FunctionTok{cumsum}\NormalTok{(n))  }\SpecialCharTok{\%\textgreater{}.\%}
  \FunctionTok{filter}\NormalTok{(., date\_round }\SpecialCharTok{\textgreater{}=}\NormalTok{ courses}\SpecialCharTok{$}\NormalTok{start[courses}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}006"}\NormalTok{] }\SpecialCharTok{\&}\NormalTok{ date\_round }\SpecialCharTok{\textless{}=}\NormalTok{ courses}\SpecialCharTok{$}\NormalTok{end[courses}\SpecialCharTok{$}\NormalTok{icourse }\SpecialCharTok{==} \StringTok{"S{-}BIOG{-}006"}\NormalTok{]) }\OtherTok{{-}\textgreater{}}\NormalTok{ sup\_temp}

\NormalTok{plog }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =}\NormalTok{ log\_temp, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ cumul\_commit, }\AttributeTok{x =}\NormalTok{ date\_round)) }\SpecialCharTok{+}
