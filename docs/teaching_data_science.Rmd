...
The analysis of variance and the post-hoc Honest Significant Difference (HSD) of Tukey.

The Self-Organizing Map (SOM) allow an n-dimensional object to be projected into a 2-dimensional object \cite{Kohonen1995}. Like a principal component analysis (PCA), this method will bring similar objects closer together and different objects further apart. The {kohonen} R package implements these methods \cite{Wehrens2018}.
