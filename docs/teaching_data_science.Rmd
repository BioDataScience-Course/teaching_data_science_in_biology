...
```{r fig_learn_trials, fig.cap="Average number of retries that where required for each student to find the right answer in learnr tutorials exercises (year 2020-2021). This measure is used as an indirect, but objective measurement of the cognitive workload."}
set.seed(87436)
...
```{r fig_rtlx, message=FALSE, warning=FALSE, fig.cap="Perceived workload for the learnr tutorials in the three courses. The black circle is the mean RTLX value. The number above each box is the number of respondants."}
set.seed(253)
...
```{r fig_exams_projects, fig.cap="Grades obtained at the final exam in function of grades obtained for the projects for courses A and B."}
...
```{r fig_som, fig.cap="Self-organizing map of the student activities across the three courses in 2020-2021."}
set.seed(3749)
